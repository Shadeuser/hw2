...
//        }
        ...
        //7
         int[] grInt = new int[10];
         for (int i = 0; i <= grInt.length - 1; i++) {
            grInt[i] = (int)(Math.random()*25);
         }
        int n = 1;
        int oldN1;
        int oldN2;
...
//        int[][] grInt = new int[2][];
//        grInt[0] = new int[10];
//        for (int i = 0; i <= grInt[0].length-1; i++) {
//            grInt[0][i] = (int)(Math.random()*25);
//        }
//        int n = 25;
//        grInt[1] = new int[grInt[0].length+n];
//        System.out.println(grInt[0].length+"   " +grInt[1].length);
//        for (int i = 0; i <= grInt[0].length-1; i++) {
//            grInt[1][i + n] = grInt[0][i];
//        }
//        grInt[0]=grInt[1];
//        grInt[1] = new int[0];
//        System.out.println(Arrays.toString(grInt[0]));
//        System.out.println(Arrays.toString(grInt[1]));
